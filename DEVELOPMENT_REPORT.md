...
| **api_jjjc 分段 R2** | `runner_sections` / `race_sectionals` | `jjjc_sectionals_sync.py` ← `GET /api/export/sectionals`（`jjjc.sectionals.v1`；見 `docs/JJJC_DOWNSTREAM_CONTRACT.md`） |
