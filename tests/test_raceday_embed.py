...
class RacedayEmbedApiTest(unittest.TestCase):
    ...
    def test_racecard_board_prototype_serves(self):
        ...
        self.assertIn('class="anno"', r.text)
        self.assertIn("anno-lab", r.text)
        self.assertIn("annoMarquee", r.text)
        self.assertIn("公告", r.text)
        self.assertIn("聯繫客服", r.text)
        ...
        self.assertIn("grid-template-columns: 25px minmax(0, 1fr)", r.text)
        self.assertIn("grid-template-rows: 31px minmax(0, 1fr)", r.text)
        self.assertIn("color: #111", r.text)
        self.assertIn(".sortable.on { color: #2c5f8a; }", r.text)
        ...
        self.assertIn("horse-sheet", r.text)
        self.assertIn("openHorseSheet", r.text)
        self.assertIn("closeHorseSheet", r.text)
        ...
        self.assertIn("board-head-pin", r.text)
        self.assertIn("board-head-x", r.text)
        self.assertIn("syncHeadScrollLeft", r.text)
        self.assertIn("bindHorseHeadScroll", r.text)
        self.assertIn("overflow-y: clip", r.text)
        self.assertNotIn("translate3d(", r.text)
        self.assertNotIn("board-lock-pin", r.text)
        self.assertNotIn("syncHorseHeadPin", r.text)
        self.assertNotIn("is-vpinned", r.text)
        self.assertNotIn("head-scroll-track", r.text)
        self.assertNotIn("syncHeadScrollTrack", r.text)
        self.assertIn("qin-panel", r.text)
        self.assertIn("qin-tbl", r.text)
        self.assertIn("qin-x", r.text)
        self.assertIn("overscroll-behavior: none", r.text)
        self.assertIn("-webkit-overflow-scrolling: touch", r.text)
        self.assertIn("bindQinOverscrollGuard", r.text)
        self.assertIn("startWrapInertia", r.text)
        self.assertIn("stopWrapInertia", r.text)
        self.assertIn("sampleFingerVel", r.text)
        self.assertIn("wrap.scrollTop -= deltaY", r.text)
        self.assertNotIn("handedOff", r.text)
        self.assertIn("qin-rh", r.text)
        self.assertIn("qin-ch", r.text)
        self.assertIn("data-qin-key", r.text)
        ...
        self.assertIn("位置", r.text)
        self.assertIn('scope="row"', r.text)
        self.assertIn(".qin-tbl .qin-rh {\n      position: sticky", r.text)
        self.assertIn(".qin-tbl .qin-ch {\n      position: sticky", r.text)
        self.assertIn("qin-mode-cell", r.text)
        self.assertIn('qin-ch qin-mode-cell', r.text)
        self.assertIn('qin-rh qin-mode-cell', r.text)
        self.assertNotIn("qin-mode-switch", r.text)
        self.assertNotIn("連/指", r.text)
        self.assertIn("上三角", r.text)
        self.assertIn("下三角", r.text)
        self.assertIn("idx-cell", r.text)
        self.assertIn(".qin-tbl .qin-c.idx-cell.idx-r", r.text)
        self.assertIn(".qin-tbl .qin-c.idx-cell.idx-g", r.text)
        self.assertIn(".qin-tbl .qin-c.idx-cell.idx-b", r.text)
        self.assertIn("background: #e74c3c", r.text)
        self.assertIn("連贏賠率", r.text)
        self.assertIn("連贏指數", r.text)
        ...
        self.assertIn("ensureRace7Has6Runners", r.text)
        self.assertIn("demoTrim6", r.text)
        self.assertIn("ensureRace6Has10WithScratch7", r.text)
        self.assertIn("demoTrim10Scratch7", r.text)
        self.assertIn("二十駒演示", r.text)
        self.assertIn("board-x", r.text)
        self.assertNotIn("qinPreviewN", r.text)
        self.assertNotIn("qin-preview", r.text)
        self.assertNotIn("qin-dense", r.text)
        self.assertNotIn("qinIdxToggle", r.text)
        self.assertNotIn("qin-idx-block", r.text)
        self.assertNotIn("date-row", r.text)
        self.assertNotIn("▾", r.text)
        self.assertNotIn('class="hint"', r.text)
        self.assertNotIn("資料截自馬會", r.text)
