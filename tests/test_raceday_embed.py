...
class RacedayEmbedApiTest(unittest.TestCase):
    ...
    def test_racecard_board_prototype_serves(self):
        ...
        self.assertIn(".hno", r.text)
        self.assertIn("font-size: 18px", r.text)
        self.assertIn(".odds .win { font-size: 15px", r.text)
        self.assertIn(".odds .pla { font-size: 13px", r.text)
        ...
        self.assertIn("height: 46px", r.text)
