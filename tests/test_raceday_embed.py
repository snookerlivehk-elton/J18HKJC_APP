...
class RacedayEmbedApiTest(unittest.TestCase):
    ...
    def test_racecard_board_prototype_serves(self):
        ...
        self.assertIn("head-scroll-track", r.text)
        self.assertIn("syncHeadScrollTrack", r.text)
        self.assertIn("bindHorseHeadScroll", r.text)
        self.assertNotIn("is-vpinned", r.text)
        self.assertNotIn("syncHorseHeadPin", r.text)
        self.assertNotIn("measureHorsePinGeometry", r.text)
        self.assertNotIn("syncHorseHeadLockX", r.text)
        ...
        self.assertIn("qin-title", r.text)
        self.assertIn("position: sticky", r.text)
        self.assertNotIn("qin-head-pin", r.text)
        self.assertNotIn("syncQinHeadTrack", r.text)
        self.assertNotIn("bindQinHeadScroll", r.text)
