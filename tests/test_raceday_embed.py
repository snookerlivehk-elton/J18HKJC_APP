...
class RacedayEmbedApiTest(unittest.TestCase):
    ...
    def test_racecard_board_prototype_serves(self):
        ...
        self.assertIn(".hno", r.text)
        self.assertIn("font-size: 19px", r.text)
        self.assertIn(".odds .win { font-size: 16px", r.text)
        ...
        self.assertIn("gap: 2px", r.text)
        self.assertIn(".draw-no", r.text)
        self.assertIn("border-radius: 50%", r.text)
        self.assertIn("font-size: 16px;\n      font-weight: 400", r.text)
        self.assertIn("width: 18px; height: 18px", r.text)
        self.assertIn("--head-fs: 14px", r.text)
